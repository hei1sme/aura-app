...
<script lang="ts">
  ...
  onMount(async () => {
    ...
    unlisteners.push(sessionStarted, sessionPaused, sessionResumed, sessionEnded);
  ...
  $: breakEmoji = breakType === 'micro' ? '👁️' : breakType === 'macro' ? '🧘' : '💧';
  $: remainingSeconds = $nextBreak?.remaining_seconds ?? 0;
  $: progress = remainingSeconds > 0 && $nextBreak 
    ? Math.min(100, (remainingSeconds / ($nextBreak.duration_seconds || 1200)) * 100)
    : 0;
</script>
  ...
  <div class="hub-content">
    {#if $sessionState === 'idle'}
      ...
      <div class="state-idle animate-fade-in">
        ...
        <button class="btn-primary btn-large btn-glow" on:click={handleStartSession}>
    ...
    {:else if $sessionState === 'active'}
      ...
      <div class="state-active animate-fade-in">
        ...
        <div class="relative flex items-center justify-center mb-6">
          ...
          <svg class="w-52 h-52 transform -rotate-90" viewBox="0 0 288 288">
            ...
            <circle
              ...
              style="filter: drop-shadow(0 0 8px {$nextBreak?.theme_color || '#8B5CF6'}80)"
            />
          </svg>
          ...
          <div class="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span class="countdown-time" style="margin-bottom: 0;">{formatTime(remainingSeconds)}</span>
            
            <div class="next-break-info" style="margin-top: 0.2rem;">
              <span class="break-icon" style="font-size: 0.85em">{breakEmoji}</span>
        ...
        <div class="controls-grid">
           <button class="btn-control btn-pause" on:click={handlePauseSession} title="Pause Session">
           ...
           <button class="btn-control btn-reset" on:click={handleEndSession} title="End Session">
             <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 20 20" fill="currentColor">
    ...
    {:else if $sessionState === 'paused'}
      ...
      <div class="state-paused animate-fade-in">
        ...
        <button class="btn-primary btn-large btn-resume" on:click={handleResumeSession}>
          <svg xmlns="http://www.w3.org/2000/svg" class="btn-icon" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
          </svg>
          Resume Focus
...
<style>
  ...
  @keyframes breathe {
    ...
    50% { transform: scale(1.05); box-shadow: 0 0 10px rgba(139, 92, 246, 0.3); }
