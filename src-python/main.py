...
class AuraEngine:
    ...
    def __init__(self, db: Optional[DatabaseManager] = None):
        ...
        auto_detect_fullscreen = self._db.get_setting("auto_detect_fullscreen", "true") == "true"
        ...
        if command == "complete_break":
            ...
            if key and value is not None:
                ...
                if key in ["micro_break_interval", "micro_break_duration"]:
                    ...
                    import sys
                    print(f"[Engine] auto_detect_fullscreen set to: {self._monitor.auto_detect_fullscreen}", 
        ...
        try:
            while self._running:
                ...
                if frame_accumulator >= 1.0:
                    ...
                    self._scheduler.update(is_active, frame_accumulator, is_immersive=is_immersive)
